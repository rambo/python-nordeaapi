...
setup(
    ...
    packages=['nordeaapi', 'nordeaapi.errors', ],
    license='MIT',
    long_description=open('README.md').read(),
    description='Implement Pythonic wrappers for Nordea Open Banking JSON-REST API',
    install_requires=list(filter(bool, (x.strip() for x in open('requirements.txt').readlines()))),
    url='https://github.com/rambo/python-nordeaapi',
)
